...
var BlocksSql = {
  ...
  getRewardByHeight: 'SELECT reward,height FROM blocks where "height" = ${height};',

  getSupply: 'SELECT supply from blocks where "id" = ${id}',

  getSupplyByHeight: 'SELECT supply from blocks where "height" = ${height};'
};
